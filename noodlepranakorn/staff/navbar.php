...
<nav class="navbar navbar-expand-lg navbar-light" style="background-: #29150c;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <font size="5px">
        <a class="nav-link text-info" href="my_order.php?page=mycart"><i class="fas fa-journal-whills"></i> รายการออเดอร์</a>
        </font> 
      </li>
    </ul>
  </div>
  <form class="form-inline my-2 my-lg-2" name="qp" action="index.php" method="GET">
    <a class="navbar-brand text-light" href="index.php"><font size="5px"><i class="fas fa-id-badge"></i> หน้าสำหรับพนักงาน</font></a>&nbsp;&nbsp;&nbsp;&nbsp;
    <?php 
    if ($user_id!='') {
    ?>
